...
This README provides a brief summary of the project, highlighting our data sources, methodologies, and key findings. It serves as a quick guide to help you understand the structure of the repository and the nature of the outputs contained within. If you want to read the full study, please click here: [AnaMikadze_AutocraticMiddleClass.pdf](./AnaMikadze_AutocraticMiddleClass.pdf)
